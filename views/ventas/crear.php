...
<div class="container mt-5">
    <div class="text-center mb-4">
        <h2 class="d-inline" style="background-color: #dc3545; color: white; padding: 10px; border-radius: 5px;">
            <i class="fas fa-shopping-cart" style="color: white;"></i> Registrar Nueva Venta
        </h2>
    </div>
    ...
    <form id="venta-form" action="../../controllers/ventaController.php" method="POST" class="card p-4 shadow-sm">
        ...
        <div class="form-group">
            ...
            <select name="cliente_id" id="cliente_id" class="form-control" required>
                ...
                <?php while ($fila = $clientes->fetch(PDO::FETCH_ASSOC)): ?>
                    <option value="<?php echo $fila['id']; ?>"><?php echo htmlspecialchars($fila['dni']) . " - " . htmlspecialchars($fila['nombre']); ?></option>
                <?php endwhile; ?>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="producto_id" id="producto_id" class="form-control" required>
                ...
                <?php while ($fila = $productos->fetch(PDO::FETCH_ASSOC)): ?>
                    <option value="<?php echo $fila['id']; ?>" data-precio="<?php echo $fila['precio']; ?>">
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="ganancia" id="ganancia" class="form-control" placeholder="Monto de ganancia" required>
        </div>
        ...
        <button type="submit" name="crearVenta" class="btn btn-danger">
